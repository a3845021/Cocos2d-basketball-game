...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	if (!glview) {
		...
		glview = GLViewImpl::createWithRect("network", Rect(0, 0, designResolutionSize.width, designResolutionSize.height));//HelloWorld
#else
	...
	FileUtils::getInstance()->addSearchPath("res");//加进去的
